        ...
        try:
            ...
            if not msg.media:
                if msg.text:
                    ...
                    await edit.delete()
                    return
            edit = await client.edit_message_text(sender, edit_id, "Trying to Download 🔽⬇️⬇️⬇️.")
            ...
            print(file)
            await edit.edit('Preparing to Upload🔼⬆️⬆️⬆️')
            caption = None
...
async def get_bulk_msg(userbot, client, sender, msg_link, i):
    x = await client.send_message(sender, "[b]Processing!![/b]")
